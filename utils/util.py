...
def get_noise_pred_single(latents, t, guidance_scale, context, uncond_context, unet):
    # noise_pred = unet(latents, t, image_hidden_states=None, encoder_hidden_states=context)["sample"]
    noise_cond = unet(latents, t, image_hidden_states=None, encoder_hidden_states=context)["sample"]
    noise_uncond = unet(latents, t, image_hidden_states=None, encoder_hidden_states=uncond_context)["sample"]
